    ...
    jQuery(document).ready(function() {
        ...
        jQuery("#equip_svc").jqGrid({
            ...
            colModel: [
                ...
                { name: 'service_dt', index: 'service_dt', width: 100 },
   		        ...
   		        { name: 'hours', index: 'hours', width: 60 },
        ...
        jQuery("#toolgrid").jqGrid({
            ...
            //            rowNum: 100,
            rowNum: 5000,
            colNames: ['ID', 'Item', 'Description', 'Manufacturer', 'Size', 'Work Loc', 'Reg By', 'Mng By', 'Calibrate Due', '', '', 'Managed By Date', 'Model #', 'Serial #', 'Year Bought', 'Cost', 'Stolen', 'Sold', 'Electrical', 'Lojack', 'In Repair', 'Totaled', 'Comments', '', '', 'Unknown', 'ImgCnt'],
            colModel: [
        ...
        jQuery("#tool_asgn").jqGrid({
            ...
            ondblClickRow: function(rowid) {
                ...
                if (data.tool_id == null)
                    ...
                    if (data.asgn_condition_id.length > 0)
                        $("#ddlToolAsgnCond option:contains(" + data.asgn_condition_id + ")").attr('selected', 'selected');

                    if (data.ret_condition_id.length > 0)
                        $("#ddlToolRetCond option:contains(" + data.ret_condition_id + ")").attr('selected', 'selected');
        ...
        $(function() {
            $("#rpt_dialog_hist").dialog({
                ...
                close: function(event, ui) {
                    $(ui).find('#dtReportFrom').datepicker('hide');
                    $(ui).find('#dtReportTo').datepicker('hide');
                }
            })
        });
        ...
        $(function() {
            $("#equip_svc_edit_dlg").dialog({
                ...
                resizable: false,
                open: function(event, ui) {
                    $(ui).find('#dtEquipSvcDt').datepicker('enable');
                },
                close: function(event, ui) {
                    $(ui).find('#dtEquipSvcDt').datepicker('hide');
                }
            })
        });
        ...
        $(function() {
            $("#tool_svc_edit_dlg").dialog({
                ...
                resizable: false,
                open: function(event, ui) {
                    $(ui).find('#dtToolSvcDt').datepicker('enable');
                },
                close: function(event, ui) {
                    $(ui).find('#dtToolSvcDt').datepicker('hide');
                }
            })
        });
        ...
        $(function() {
            $("#equip_asgn_edit_dlg").dialog({
                ...
                resizable: false,
                open: function(event, ui) {
                    $(ui).find('#dtEquipAsgnDt').datepicker('enable');
                    $(ui).find('#dtEquipRetDt').datepicker('enable');
                },
                close: function(event, ui) {
                    $(ui).find('#dtEquipAsgnDt').datepicker('hide');
                    $(ui).find('#dtEquipRetDt').datepicker('hide');
                }
            })
        });
        ...
        $(function() {
            $("#tool_asgn_edit_dlg").dialog({
                ...
                resizable: false,
                open: function(event, ui) {
                    $(ui).find('#dtToolAsgnDt').datepicker('enable');
                    $(ui).find('#dtToolRetDt').datepicker('enable');
                },
                close: function(event, ui) {
                    $(ui).find('#dtToolAsgnDt').datepicker('hide');
                    $(ui).find('#dtToolRetDt').datepicker('hide');
                }
            })
        });
        ...
        $(function() {
            $("#equip_edit_dlg").dialog({
                ...
                resizable: false,
                open: function(event, ui) {
                    $(ui).find('#dtEquipInspDue').datepicker('enable');
                    $(ui).find('#dtEquipMngByDt').datepicker('enable');
                    $(ui).find('#dtEquipMilesDt').datepicker('enable');
                    $(ui).find('#dtEquipTagExp').datepicker('enable');
                },
                close: function(event, ui) {
                    $(ui).find('#dtEquipInspDue').datepicker('hide');
                    $(ui).find('#dtEquipMngByDt').datepicker('hide');
                    $(ui).find('#dtEquipMilesDt').datepicker('hide');
                    $(ui).find('#dtEquipTagExp').datepicker('hide');
                }
            })
        });
        ...
        $(function() {
            $("#tool_edit_dlg").dialog({
                ...
                resizable: false,
                open: function(event, ui) {
                    $(ui).find('#dtToolMngByDt').datepicker('enable');
                    $(ui).find('#dtCalibrationDue').datepicker('enable');
                },
                close: function(event, ui) {
                    $(ui).find('#dtToolMngByDt').datepicker('hide');
                    $(ui).find('#dtCalibrationDue').datepicker('hide');
                }
            })
        });
        ...
        $(function() {
            $("#smalltool_edit_dlg").dialog({
                ...
                resizable: false,
                open: function(event, ui) {
                    $(ui).find('#dtSmallToolMngByDt').datepicker('enable');
                    $(ui).find('#dtSmallToolAsgnDt').datepicker('enable');
                    $(ui).find('#dtSmallToolRetDt').datepicker('enable');
                },
                close: function(event, ui) {
                    $(ui).find('#dtSmallToolMngByDt').datepicker('hide');
                    $(ui).find('#dtSmallToolAsgnDt').datepicker('hide');
                    $(ui).find('#dtSmallToolRetDt').datepicker('hide');
                }
            })
        });
        ...
        $('#equip_svc_edit_form').ajaxForm(function(data) {
            ...
            if (respArray[0] == "Success") {
                ...
                if ($('#chkEquipSvcDue').attr('checked') == true) {
        ...
        $('#equip_edit_form').ajaxForm(function(data) {
            ...
            if (respArray[0] == "Success") {
                ...
                var chkEquipSold;
                if ($('#chkEquipSold').attr('checked') == true) {
                    chkEquipSold = "True";
                }
                else {
                    chkEquipSold = "False";
                ...
                var chkEquipStolen;
                if ($('#chkEquipStolen').attr('checked') == true) {
                    chkEquipStolen = "True";
                }
                else {
                ...
                var chkEquipLojack;
                if ($('#chkEquipLojack').attr('checked') == true) {
                    chkEquipLojack = "True";
                }
                else {
                ...
                var chkEquipUnknown;
                if ($('#chkEquipUnknown').attr('checked') == true) {
                ...
                if ($('#chkEquipInRepair').attr('checked') == true) {
                ...
                var chkEquipTotaled;
                if ($('#chkEquipTotaled').attr('checked') == true) {
                ...
                var chkHUTSticker;
                if ($('#chkHUTSticker').attr('checked') == true) {
                    chkHUTSticker = "True";
                }
                else {
                    chkHUTSticker = "False";
                ...
                var chkApportioned;
                if ($('#chkEquipApportioned').attr('checked') == true) {
                    chkApportioned = "True";
                }
                else {
                ...
                var chkIFTASticker;
                if ($('#chkIFTASticker').attr('checked') == true) {
                    chkIFTASticker = "True";
                }
                else {
                ...
                var chkEquipGPS;
                if ($('#chkEquipGPS').attr('checked') == true) {
                    chkEquipGPS = "True";
                }
                else {
                    chkEquipGPS = "False";
        ...
        $('#tool_edit_form').ajaxForm(function(data) {
            ...
            if (respArray[0] == "Success") {
                ...
                var chkToolSold;
                if ($('#chkToolSold').attr('checked') == true) {
                    chkToolSold = "True";
                }
                else {
                    chkToolSold = "False";
                ...
                if ($('#chkToolElectrical').attr('checked') == true) {
                ...
                var chkToolLojack;
                if ($('#chkToolLojack').attr('checked') == true) {
                    chkToolLojack = "True";
                }
                else {
                    chkToolLojack = "False";
                ...
                var chkToolUnknown;
                if ($('#chkToolUnknown').attr('checked') == true) {
                    chkToolUnknown = "True";
                }
                else {
                ...
                var chkToolInRepair;
                if ($('#chkToolInRepair').attr('checked') == true) {
                ...
                var chkToolStolen;
                if ($('#chkToolStolen').attr('checked') == true) {
                    chkToolStolen = "True";
                }
                else {
                    chkToolStolen = "False";
                ...
                var chkToolTotaled;
                if ($('#chkToolTotaled').attr('checked') == true) {
                    chkToolTotaled = "True";
                }
                else {
    ...
    function OpenEquipEditSvcDlg(dta) {
        ...
        $.get("/EquipTrack/GetEquipSvcEditDlg/", {}, function(data) {
            ...
            $("#lstEquipSvcTypes option:contains(" + dta.serv_descr + ")").attr('selected', 'selected');
        });
    ...
    function OpenToolSvcDlg(dta) {
        ...
        $.get("/EquipTrack/GetToolSvcEditDlg/", {}, function(data) {
            ...
            $("#lstToolSvcTypes option:contains(" + dta.serv_descr + ")").attr('selected', 'selected');
        });
    ...
    function OpenEquipEditAsgnDlg(dta) {
        ...
        $.get("/EquipTrack/GetEquipAsgnEditDlg/", {}, function(data) {
            ...
            //            $("#ddlAssignedTo option:contains(" + dta.assigned_to + ")").attr('selected', 'selected');
    ...
    function OpenEquipEditDlg(dta) {
        ...
        $.get("/EquipTrack/GetEquipEditDlg/", {}, function(data) {
            ...
            if (oper == "Edit") {
                $('#ddlEquipMake').val(dta.make_descr);
                $('#ddlEquipModel').val(dta.model_descr);
                $('#ddlEquipType').val(dta.type_desc);
    ...
    function OpenToolEditDlg(dta) {
        ...
        $.get("/EquipTrack/GetToolEditDlg/", {}, function(data) {
            ...
            if (oper == "Edit") {
                $('#ddlToolMfg').val(dta.tool_mfg_descr);
                $('#ddlToolType').val(dta.tools_type_descr);
                $('#ddlToolDesc').val(dta.tools_descr_descr);
                $('#ddlToolSize').val(dta.size_descr);
