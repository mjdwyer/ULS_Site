...
//                      $('#txtEquipSvcHours').val('');
    ...
    $('#equip_edit_form').ajaxForm(function(data) {
        ...
        if (respArray[0] == "Success") {
            ...
            if ($('#chkEquipToBeSold').attr('checked') == true) {
            ...
            var chkEquipLeased;
            if ($('#chkEquipLeased').attr('checked') == true) {
                chkEquipLeased = "True";
            }
            else {
            ...
            var chkEquipEZPASS;
            if ($('#chkEquipEZPASS').attr('checked') == true) {
                chkEquipEZPASS = "True";
            }
            else {
            ...
            if ($('#chkEquipFuelCard').attr('checked') == true) {
    ...
    $('#tool_edit_form').ajaxForm(function(data) {
        ...
        if (respArray[0] == "Success") {
            ...
            var chkToolToBeSold;
            if ($('#chkToolToBeSold').attr('checked') == true) {
